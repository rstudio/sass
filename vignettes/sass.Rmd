...
Sass can create different themes quickly by using functions (or [mixins](https://sass-lang.com/guide)).  In the [shiny example app](https://gallery.shinyapps.io/sass-theme/) below, we switch between different color themes.

```{r echo = FALSE}
knitr::include_app("https://gallery.shinyapps.io/sass-theme/", height = "350px")
```
