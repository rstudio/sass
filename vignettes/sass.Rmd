...
This article will briefly demonstrate how to compile custom CSS in a live Shiny to change stlying in response to user input.

## Variables

Sass variables are key to generating dynamic CSS, because they define the components of the styling can be changed during compilation.
...
Since Sass is fully CSS compatible, any styling option is available, including dimensions like height and width of images.
